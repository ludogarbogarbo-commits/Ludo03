...
import { AmenitiesSectionClient } from "./amenities-section-client"

export function AmenitiesSection() {
  return <AmenitiesSectionClient />
  return (
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-2xl font-light text-foreground">Inside</h3>
            </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-2xl font-light text-foreground">Outside</h3>
            </div>
            <ul className="space-y-4">
